...
/*********** my Variables************/
int tagId = 0;
int anchorId = 4;//to change
int antennaDelay = 16454;
...
void setup() {
  ...
  DW1000.commitConfiguration(antennaDelay);
  ...
  Serial.print("Anchor ID: "); Serial.println(anchorId);
...
void transmitRangeReport(float curRange) {
  ...
  data[16] = anchorId;
  data[17] = tagId;
  data[18] = (int)curRange;
  data[19] = (int)((curRange - (int)curRange) * 100);
