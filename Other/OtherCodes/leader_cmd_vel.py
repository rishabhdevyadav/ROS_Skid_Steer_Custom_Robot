...
class defineTarget():
	def __init__(self):
		...
		self.cmd_vel_pub = rospy.Publisher('/R9/cmd_vel', Twist, queue_size=10)
		self.time_start = rospy.Time.now()
		self.time_to_run = rospy.get_param('~time_to_run',50000)
		self.v_target = rospy.get_param('~v_target',0.06) # in mtr/sec
		self.w_target = rospy.get_param('~w_target',-0.00)    
