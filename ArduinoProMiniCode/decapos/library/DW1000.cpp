...
void DW1000Class::commitConfiguration(int antenna_delay) {
	...
	// writeValueToBytes(antennaDelayBytes, 16453, LEN_STAMP);
	// Wall-1 - 1 dots 
	// writeValueToBytes(antennaDelayBytes, 16445, LEN_STAMP);
	// Wall-2 - 2 dots 
	// writeValueToBytes(antennaDelayBytes, 16451, LEN_STAMP);
