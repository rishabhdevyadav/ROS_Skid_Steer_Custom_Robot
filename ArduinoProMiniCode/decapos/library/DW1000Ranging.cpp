...
void DW1000RangingClass::configureNetwork(uint16_t deviceAddress, uint16_t networkId, const byte mode[], int antenna_delay) {
	...
	DW1000.commitConfiguration(antenna_delay);
...
void DW1000RangingClass::startAsAnchor(char address[], const byte mode[], int antenna_delay, const bool randomShortAddress) {
	//save the address
	...
	DW1000Ranging.configureNetwork(_currentShortAddress[0]*256+_currentShortAddress[1], 0xDECA, mode, antenna_delay);
...
void DW1000RangingClass::startAsTag(char address[], const byte mode[], int antenna_delay, const bool randomShortAddress) {
	//save the address
	DW1000.convertToByte(address, _currentAddress);
	//write the address on the DW1000 chip
	DW1000.setEUI(address);
