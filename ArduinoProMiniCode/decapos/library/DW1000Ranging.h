...
public:
	...
	static void    configureNetwork(uint16_t deviceAddress, uint16_t networkId, const byte mode[], int antenna_delay);
	static void    generalStart();
	static void    startAsAnchor(char address[], const byte mode[], int antenna_delay, const bool randomShortAddress = true);
	static void    startAsTag(char address[], const byte mode[], int antenna_delay, const bool randomShortAddress = true);
