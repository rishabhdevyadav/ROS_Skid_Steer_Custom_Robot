...
class AnalogSensor(Sensor):
    def __init__(self, *args, **kwargs):
        ...
        self.pub = rospy.Publisher(
            "~sensor/" + self.name, Analog, queue_size=5
        )
...
class AnalogFloatSensor(Sensor):
    def __init__(self, *args, **kwargs):
        ...
        self.pub = rospy.Publisher(
            "~sensor/" + self.name, AnalogFloat, queue_size=5
        )
...
class DigitalSensor(Sensor):
    def __init__(self, *args, **kwargs):
        ...
        self.pub = rospy.Publisher(
            "~sensor/" + self.name, Digital, queue_size=5
        )
...
class RangeSensor(Sensor):
    def __init__(self, *args, **kwargs):
        ...
        self.pub = rospy.Publisher(
            "~sensor/" + self.name, Range, queue_size=5
        )
...
if __name__ == '__main__':
    ...
    mySensor = SonarSensor(
        myController, "My Sonar", type=Type.PING, pin=0, rate=10
    )
